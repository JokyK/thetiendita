...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $consulta = "SELECT * FROM ventas WHERE num_factura = '$numFactura'";
    ...
    <div class="container">
        <form method="post" class="form">
            ...
            <label for="nombre_producto">DUI</label>
            ...
            <a style="background-color: red; padding: 5px; color: white; margin-bottom:10px;" href="../fpdf/PruebaV.php?factura=<?php echo$numFactura?>&dui=<?php echo$dui?>&cod_producto=<?php echo$cod_producto?>&cantidad=<?php echo$cantidad?>&fecha=<?php echo$fecha?>">GENERAR PDF</a>
